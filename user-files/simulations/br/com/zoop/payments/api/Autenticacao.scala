...
object Autenticacao {
  val requestNovo = exec(http("Autenticacao")
    ...
    .body(StringBody("{"amount": 100, "currency": "BRL", "payment_type": "credit", "description": "authorization stress test", "statement_descriptor": "@Ingresse.com", "on_behalf_of": "0184f9c9501c481eafcf414a2d7eec46", "source": {"amount": 100, "usage": "single_use", "currency": "BRL", "type": "card", "card": { "holder_name": "ZOOP SQUAD QA", "expiration_month": "03", "expiration_year": "2030", "security_code": "737", "card_number": "4444333322221111"}}}")))
